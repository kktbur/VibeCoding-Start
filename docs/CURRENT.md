...
- The v0.3.0 governance scope is recorded in [Plan 007](plans/007-v0.3.0-ecosystem-governance.md) and [ADR-0007](decisions/0007-v0.3.0-public-governance-surface.md); local implementation is in progress and no v0.3.0 remote PR, tag, or Release is claimed yet.
...
- Remote Actions are verified as passing for the M1 PR head, merged `main` commits, the published `v0.1.1` and `v0.2.0` tags, and the v0.2.0 candidate PR/push head; the v0.1.0 release metadata remains valid and unchanged.
