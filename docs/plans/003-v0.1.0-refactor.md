...
| G8 Release | Tag and GitHub Release are created only after acceptance and remote CI verification | PENDING — merge commit `48a14a8…` and post-merge CI are verified; current session cannot write tag/Release objects |
